...
![数据类型实现模型描述](https://tawen.github.io/res/js_object_model_implementation.jpg)
...
![Prototype](https://tawen.github.io/res/js_object_model_prototype.jpg)
...
![练习](https://tawen.github.io/res/js_object_model_construct.jpg)
...
### JavaScript对象模型
![JavaScript对象模型](https://tawen.github.io/res/js_object_model.jpg)
红色虚线表示隐式Prototype链。
